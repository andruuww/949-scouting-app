...
// debugging code
// the last asset in the array is the one that might show an error, but might not actually the one that is causing the error
// let currentAsset = '';
// let invalidAssets = [];
// evt.waitUntil(
...
//             .catch((err) => {
//                 console.log('error caching', err);
//                 invalidAssets.push(currentAsset);
//             })
//             .then(() => {
//                 console.log('done caching');
