		...
		<>
			...
			<div className='grid gap-6'>
				...
				<div className='grid grid-cols-4 items-center gap-4'>
					...
					<Select
						onValueChange={(value) => handleChangeSimple('drivetrain', value)}
						value={formData.drivetrain ? formData.drivetrain : ''}
						defaultValue='swerve'>
						<SelectTrigger className='col-span-3' aria-label='Select type'>
				...
				<div className='grid grid-cols-4 items-center gap-4'>
					...
					<div className='col-span-3 flex flex-row items-stretch gap-x-4'>
						<Input
							...
							placeholder='28'
							onChange={handleChange}
							value={formData.dimensionLength ? formData.dimensionLength : ''}
						/>
						<div>
						...
						<Input
							...
							placeholder='32'
							onChange={handleChange}
							value={formData.dimensionWidth ? formData.dimensionWidth : ''}
						/>
					</div>
				</div>
				<div className='grid grid-cols-4 items-center gap-4'>
					...
					<div className='col-span-3'>
						<div className='items-center flex space-x-2'>
							<Checkbox
								...
								onCheckedChange={(checked) =>
									handleScoringLevelsChange('l1', checked === true)
								}
						...
						<div className='items-center flex space-x-2'>
							<Checkbox
								...
								aria-label='Level 2'
								onCheckedChange={(checked) =>
									handleScoringLevelsChange('l2', checked === true)
								}
						...
						<div className='items-center flex space-x-2'>
							<Checkbox
								...
								aria-label='Level 3'
								onCheckedChange={(checked) =>
									handleScoringLevelsChange('l3', checked === true)
								}
					...
					<div className='col-span-3'>
						<div className='items-center flex space-x-2'>
							<Checkbox
								...
								aria-label='Cones'
								onCheckedChange={(checked) =>
									handleIntakeTypesChange('cone', checked === true)
								}
								checked={
									formData.intakeCapabilities?.includes('cone') ? true : false
								}
							/>
							<div className='grid gap-1.5 leading-none '>
						...
						<div className='items-center flex space-x-2 pt-2'>
							<Checkbox
								...
								aria-label='Cubes'
								onCheckedChange={(checked) =>
									handleIntakeTypesChange('cube', checked === true)
								}
								checked={
									formData.intakeCapabilities?.includes('cube') ? true : false
								}
							/>
							<div className='grid gap-1.5 leading-none'>
				...
				<div className='grid grid-cols-4 items-center gap-4'>
					...
					<Textarea
						...
						className='col-span-3'
						onChange={(e) => handleChangeSimple('notes', e.target.value)}
